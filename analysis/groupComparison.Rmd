...
load("~/Dropbox/github_repos/westAuthoritarianism/westernAuthoritarianism/tmp/models.rda")
```
...
save(dat, file = "~/Dropbox/github_repos/westAuthoritarianism/westernAuthoritarianism/tmp/dataActive.rda")
